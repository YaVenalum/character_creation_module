...
def start_training(character) -> str:
    ...
    while approve_action != 'skip':
        selected_action = input('Введите команду:')
        if selected_action in action:
            char_action = action[selected_action]
            print(char_action)
        else:
            print('Вы ввели неправильную команду')
    return print('Тренировка завершена')
